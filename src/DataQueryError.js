...
const DataQueryErrorElement = nest(
  glamorous.div({
    ...
    backgroundImage: `repeating-linear-gradient(-45deg, ${hemelblauw.lighter}, ${hemelblauw.lighter} ${stripeWidth}px, ${hemelblauw.default} ${stripeWidth}px, ${hemelblauw.default} ${stripeWidth *
      2 +
      1}px)`,
  }),
  glamorous.div({
